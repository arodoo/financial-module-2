<!-- START HEADER -->
<header class="header_wrap light_skin fixed-top hover_menu_style3">
...
<div class="top-header bg-dark light_skin d-none d-md-block">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <ul class="contact_detail list_none text-center text-md-left">
                        <li><i class="ti-mobile"></i> <?php echo $telephone_portable_ii; ?></li>
                        <li><i class="uk-icon-envelope"></i> <?php echo $emaildefault; ?> </li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <ul class="text-center text-md-right mt-2 mt-md-0">
			<?php if(empty($user)){  ?>
				<li style="font-size: 14px; float: right;" >
					<a onclick="return false;" class="nav-link pxp-header-user" href="#" style="color: #ffffff; width: 100px;" >Connexion</a>
				</li>
			<?php } ?>
                    </ul>
                </div>
    ...
    <nav class="navbar navbar-expand-lg"> 
			...
			<img class="logo_light" src="/images/Logo-PEP's.jpg?v=1" alt="PEP's" width="100" />
			<img class="logo_dark" src="/images/Logo-PEP's.jpg?v=1" alt="PEP's" width="100"/>
			<img class="logo_default" src="/images/Logo-PEP's.jpg?v=1" alt="PEP's" width="100"/>
			</a>

			<button style="margin-top: 15px;" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> Menu </button>
					...
					<?php if(!empty($user)){  ?>
							...
							<ul>
								...
								?>
									...
									<div style="padding-left: 10px;" >
										<?php if($ligne_selectcoui2['nbr_demandes_oui'] > 0){ echo " <span class='badge badge-success' title='Validée' >+".$ligne_selectcoui2['nbr_demandes_oui']."</span>"; }else{ echo "<span class='badge badge-success' title='Validée' >".$ligne_selectcoui2['nbr_demandes_oui']."</span>"; } ?>
										<?php if($ligne_selectcattente2['nbr_demandes_attente'] > 0){ echo " <span class='badge badge-warning' title='En attente' >+".$ligne_selectcattente2['nbr_demandes_attente']."</span>"; }else{ echo "<span class='badge badge-warning' title='En attente' >".$ligne_selectcattente2['nbr_demandes_attente']."</span>"; } ?>
										<?php if($ligne_selectcnon2['nbr_demandes_non'] > 0){ echo " <span class='badge badge-danger' title='Refusée' >+".$ligne_selectcnon2['nbr_demandes_non']."</span>"; }else{ echo "<span class='badge badge-danger' title='Refusée'>".$ligne_selectcnon2['nbr_demandes_non']."</span>"; } ?>
									</div>
									</li>
									<li><a class="dropdown-item nav-link nav_item" href="<?php echo "$http"; ?><?php echo "$nomsiteweb"; ?>/Messagerie.html" title="<?php echo "Messagerie"; ?>"><?php echo "Messagerie"; ?> <?php if($total_message_non_lu > 0){ echo " <span class='badge badge-success'>".$total_message_non_lu."</span>"; } ?></a></li>
							</ul>
							</div>
						</li>
						<?php } ?>
						...
						<li class="dropdown">
							...
							<ul>
								...
								$ligne_select_e = $req_select->fetch();
								$req_select->closeCursor();
								if(empty($ligne_select_e['id'])){ $colorp = "color: red !important;"; } 
								...
								$req_select->closeCursor();
								if(empty($ligne_select_o['id'])){ $coloro = "color: red !important;"; } 
								...
								$req_select->closeCursor();
								if(empty($ligne_select_i['id'])){ $colori = "color: red !important;"; } 
								...
								?>
									...
									<li><a class="dropdown-item nav-link nav_item" style="<?php if(empty($image_profil_oo)){ echo "color: red;"; } ?>" href="<?php echo "$http"; ?><?php echo "$nomsiteweb"; ?>/<?php echo "Avatar"; ?>" title="<?php echo "Ma photo"; ?>"><?php echo "2.Ma photo"; ?></a></li>
								...
								?>
									...
									<li>
									<div style="padding-left: 10px;" >
										<?php if($ligne_selectcoui['nbr_demandes_oui'] > 0){ echo " <span class='badge badge-success' title='Validée' >+".$ligne_selectcoui['nbr_demandes_oui']."</span>"; }else{ echo "<span class='badge badge-success' title='Validée' >".$ligne_selectcoui['nbr_demandes_oui']."</span>"; } ?>
										<?php if($ligne_selectcattente['nbr_demandes_attente'] > 0){ echo " <span class='badge badge-warning' title='En attente' >+".$ligne_selectcattente['nbr_demandes_attente']."</span>"; }else{ echo "<span class='badge badge-warning' title='En attente' >".$ligne_selectcattente['nbr_demandes_attente']."</span>"; } ?>
										<?php if($ligne_selectcnon['nbr_demandes_non'] > 0){ echo " <span class='badge badge-danger' title='Refusée' >+".$ligne_selectcnon['nbr_demandes_non']."</span>"; }else{ echo "<span class='badge badge-danger' title='Refusée'>".$ligne_selectcnon['nbr_demandes_non']."</span>"; } ?>
									</div>
									</li>
								...
								?>
								<li><a class="dropdown-item nav-link nav_item" href="<?php echo "$http"; ?><?php echo "$nomsiteweb"; ?>/Notifications" title="<?php echo "Notifications"; ?>"><?php echo "Notifications"; ?> <?php if($nbr_notifications > 0){ echo " <span class='badge badge-success'>".$nbr_notifications."</span>"; } ?> </a></li>
						...
						?>
						<li class="dropdown">
							<a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown" >Services <?php //if($nbr_prestation > 0){ echo " <span class='badge badge-success'>+".$nbr_prestation."</span>"; }else{ echo "<span class='badge badge-danger'>".$nbr_prestation."</span>"; } ?> </a>
							<div class="dropdown-menu">
							<ul>
								...
								?>
									<li class="dropdown-item nav-link nav_item" style="padding-left:10px; font-weight: bold;" >Crédits : <?php if($nbr_prestation > 0){ echo " <span class='badge badge-success'>+".$nbr_prestation."</span>"; }else{ echo "<span class='badge badge-danger'>".$nbr_prestation."</span>"; } ?></li>
								<hr />
								...
								?>
									...
									<li><a class="dropdown-item nav-link nav_item" href="<?php echo "$http"; ?><?php echo "$nomsiteweb"; ?>/Commandes-de-DUE" title="<?php echo "Commandes de DUE"; ?>"><?php echo "DPAE contrat"; ?></a></li>
		...
		<?php } ?>
               ...
               <!--  <li class="dropdown"><a class=" nav-link" href="#" data-toggle="dropdown"><i class="ion-android-cart"></i><span class="cart_count">2</span></a>
                	<div class="cart_box dropdown-menu dropdown-menu-right">
                    	<ul class="cart_list" style="width: 100%;" >

                             <li style="width: 100%; padding-bottom: 25px;" >
                            	<span style="float: left;" >Variable product 001</span>
                                <span class="cart_quantity" style="float: right;"> 1 x <span class="cart_amount"> <span class="price_symbole">€</span></span>78.00</span></span>
                            </li>

                        </ul>
                        <div class="cart_footer">
                        	<p class="cart_total"><strong>Total:</strong> <span class="cart_amount"> <span class="price_symbole">€</span></span>159.00</span></p>
                            <p class="cart_buttons"><a href="#" class="btn view-cart">Panier</a><a href="/Paiement" class="btn checkout">Commander</a></p>
                        </div>
                    </div>
                </li> -->
            </ul>
