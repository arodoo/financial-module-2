...
$req_selectmt->closeCursor();
	...
	?>
    	<div class="row align-items-center mb-5">
			...
			$req_select->closeCursor();
				?>
					<span style='font-weight: bold;' >Mission du <?php if(!empty($ligne_select['date_debut']) && !empty($ligne_select['date_fin']) ){ echo date('d-m-Y', $ligne_select['date_debut']); echo " au "; echo date('d-m-Y', $ligne_select['date_fin']); } ?> </span> <br />
			<?php
				if($ligne_select['lundi'] == "oui"){ echo "<span class='badge badge-info' style='margin: 2px;' > Lundi </span>"; }
				if($ligne_select['mardi'] == "oui"){ echo "<span class='badge badge-info' style='margin: 2px;' > Mardi </span> "; }
				if($ligne_select['mercredi'] == "oui"){ echo "<span class='badge badge-info' style='margin: 2px;' > Mercredi </span> "; }
				if($ligne_select['jeudi'] == "oui"){ echo "<span class='badge badge-info' style='margin: 2px;' > Jeudi </span> "; }
				if($ligne_select['vendredi'] == "oui"){ echo "<span class='badge badge-info' style='margin: 2px;' > Vendredi </span> "; }
				if($ligne_select['samedi'] == "oui"){ echo "<span class='badge badge-info' style='margin: 2px;' > Samedi </span> "; }
				if($ligne_select['dimanche'] == "oui"){ echo "<span class='badge badge-info' style='margin: 2px;' > Dimanche </span> "; }
			?>
				<?php
			}
			?>
			...
			<nav aria-label="breadcrumb d-block text-centerv" class="container2">
				<ol class="breadcrumb justify-content-center">
					...
					<?php if($statut_compte_oo != 1 || $statut_compte_oo != 6){ ?>
						<li class="breadcrumb-item"><a href="<?php echo "/Guide"; ?>">Guide</a></li>
					<?php } ?>
					<li class="breadcrumb-item active" aria-current="page"><?php echo "Photo"; ?></li>
				</ol>
			</nav>
		</div>
	</div>
...
////////////////////////////////////////////////////////////////////////////////////////////Commandes-cdd-cdi
	...
	?>
    	<div class="row align-items-center">
        	<div class="col-sm-12 text-center">
            	<div class="page-title">
            		<h1><?php echo "Commandes de CDD &amp; CDI"; ?></h1>
                </div>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center">
           	 	<li class="breadcrumb-item"><a href="<?php echo "/"; ?>"><?= $nom_proprietaire; ?></a></li>
            		<li class="breadcrumb-item active"><?php echo "Commandes de CDD &amp; CDI"; ?></li>
                   </ol>
                </nav>
             </div>
        </div>
