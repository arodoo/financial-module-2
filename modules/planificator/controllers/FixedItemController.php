...
class FixedItemController {
    ...
    public function saveItem($data) {
        ...
        error_log("FixedItemController ({$this->type}) saveItem input data: " . print_r($data, true));
        ...
        if (empty($data['name']) || empty($data['category_id']) || empty($data['amount'])) {
            error_log("Required fields missing for {$this->type}");
            return false;
        }
        ...
        try {
            ...
            error_log("{$this->type} save result: " . ($result ? "Success with ID: $result" : "Failed"));
            return $result;
        } catch (Exception $e) {
            error_log("Exception in FixedItemController::saveItem ({$this->type}): " . $e->getMessage());
            return false;
        }
    }
    ...
    public function updateItem($data) {
        ...
        // Debug log input data
        error_log("FixedItemController ({$this->type}) updateItem input data: " . print_r($data, true));
        ...
        if (empty($data[$idField]) && empty($data['item_id'])) {
            error_log("Item ID missing in update");
            return false;
        }
        ...
        if (empty($name) || empty($data['category_id']) || empty($data['amount'])) {
            error_log("Required fields missing for update");
            return false;
        }
        ...
        try {
            ...
            error_log("Exception in FixedItemController::updateItem ({$this->type}): " . $e->getMessage());
            return false;
        }
    }
    ...
    public function deleteItem($id) {
        if (!$this->currentUser['id'] || !$id) {
            error_log("Cannot delete {$this->type}: User ID or item ID missing");
            return false;
        }
        ...
        try {
            ...
            error_log("Exception in FixedItemController::deleteItem ({$this->type}): " . $e->getMessage());
            return false;
        }
    }
