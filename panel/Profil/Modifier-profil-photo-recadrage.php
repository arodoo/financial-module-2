...
/* = exif_read_data("$repertoire_chmod/$icon");
if(!empty($exif['Orientation'])) {
	$largeur =  $gettsizee[1];
	$hauteur = $gettsizee[0];
	$newhauteur = ($largeur/$hauteur);
...
?>
<script type="text/javascript">
lien_c("/<?php echo "$page_avant"; ?>");
alert_c("<?php echo "Seulement les images sont autorisés !"; ?>");
</script>
<?php
////////////RAPPORT JS
}
...
<script type="text/javascript">
lien_c("/<?php echo "$page_avant"; ?>");
alert_c("<?php echo "Vous devez choisir une image !"; ?>");
</script>
<?php
////////////RAPPORT JS
}
...
<input type="submit" class="form-control btn btn-default" name='submit_recadrage' value="<?php echo "SAUVEGARDER"; ?>" style='width:250px;'>
</form>
...
<script type="text/javascript">
lien_c("/<?php echo "$page_avant"; ?>");
alert_c("<?php echo "Votre image à bien été téléchargé !"; ?>");
</script>
<?php
////////////RAPPORT JS
