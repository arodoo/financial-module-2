...
<div id='is' class="contact-form-wrapper background-white p30" style='text-align: left;'>
	...
	<?php if ($statut_compte == 1) { ?>
		...
		<div class="row style_color">
			...
			<div class="col-sm-2">
				<select id="cat_socio" name="cat_socio" class="form-control"
					...
					<option <?php if ($cat_socio == "Cadre et profession intellectuelle supérieure") {
						echo "selected";
					} ?> value="Cadre et profession intellectuelle supérieure">Cadre et profession intellectuelle supérieure
					</option>
					...
					<option <?php if ($cat_socio == "Autre personne, sans activité professionnelle") {
						echo "selected";
					} ?> value="Autre personne, sans activité professionnelle">Autre personne, sans activité professionnelle
					</option>
				</select>
			</div>
		</div>
	<?php } elseif ($statut_compte == 2) {
		...
		<div class="row style_color">
			...
			<div class="col-sm-2">
				<select id="categorie_annonceur" name="categorie_annonceur" class="form-control"
					style='margin-bottom: 15px; <?php echo "$coloorpr"; ?>'>
					<option value="">Sélection</option>
					<option <?php if ($categorie_annonceur == "1") {
						echo "selected";
					} ?> value="1">
						Agriculteur/Maraicher/Eleveur</option>
					...
					<option <?php if ($categorie_annonceur == "7") {
						echo "selected";
					} ?> value="7">Commune, Communauté de
						communes</option>
					<option <?php if ($categorie_annonceur == "8") {
						echo "selected";
					} ?> value="8">Communauté intentionnelle
						ou autres</option>
					...
					<option <?php if ($categorie_annonceur == "12") {
						echo "selected";
					} ?> value="12">Proprietaire Bailleur
					</option>
					<option <?php if ($categorie_annonceur == "13") {
						echo "selected";
					} ?> value="13">Professionnel de santé
					</option>
		...
		<div class="row">
			<div class="col-sm-6 style_color" style='margin-bottom: 15px;'>
				...
				<input type="text" id='Telephone' name='Telephone' class="form-control"
					placeholder="<?php echo "Téléphone"; ?>" value="<?php echo "$Telephone"; ?>"
			...
			<div class="col-sm-6 style_color" style='margin-bottom: 15px;'>
				...
				<input type="text" id='Telephone_portable' name='Telephone_portable' class="form-control"
					placeholder="<?php echo "Portable"; ?>" value="<?php if (!empty($Telephone_portable)) {
